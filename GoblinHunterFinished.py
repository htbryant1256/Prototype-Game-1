        ...
        while grave_yard:
            ...
            if choice5 == "LOOT":
                ...
                while mob_health > 0:
                    ...
                    if mob_health <= 0:
                        print((mob_name).upper() + " Defeated!")
                        random_coins = random.randrange(20,30)
                        player_coins += random_coins
                        print("You recive", random_coins, "coins!\nYou now have", player_coins, "total coins!")
                    input("Press any key to continue.")
                grave_yard = False
        ...
        while birds_nest:
            ...
            while mob_health > 0:
                print(
                    "     _,.\n   ,` -.)\n    ( _/-\ -._\n   /,|`--._,-^|            ,\n   \_| |`-._/||          ,'|\n     |  `-, / |         /  /\n     |     || |        /  /\n      `r-._||/   __   /  /\n  __,-<_     )`-/  `./  /\n '  \   `---'   \   /  /\n'  \   `---'   \   /  /\n    |           |./  /\n    /           //  /\n\_/' \         |/  /\n |    |   _,^-'/  /\n |    , ``  (\/  /_\n  \,.->._    \X-=/^\n  (  /   `-._//^`\n   `Y-.____(__}\n    |     {__)")
                player_attack = (random.randrange(4, 9) + weapon_damage)
                mob_damage = random.randrange(7, 12)
                mob_health -= player_attack
                health -= mob_damage
                if player_attack >= 7:
                    print("CRITICAL HIT!")
                ...
                if mob_health <= 0:
                    print((mob_name).upper() + " Defeated!")
                    random_coins = random.randrange(15, 19)
                    player_coins += random_coins
                    print("You recive", random_coins, "coins!\nYou now have", player_coins, "total coins!")
                input("Press any key to continue.")
                birds_nest = False
...
merch_man2 = True
while merch_man2:
    merchant2 = input("You stumble accross a traveling merchant. What will you do?\n\nShop\nLeave\n").upper()
    if merchant2 == "SHOP":
        shop2 = True
        while shop2:
            print("\n\n\n\n\n\n\n\n\n\nBrowse my wares sir!")
...
while boss:
    mob_name = "dragon"
    mob_area = "evil castle"
    print("You arrive at the evil castle, inside lies the dragon, are you ready?")
    input("\nPress any key to enter combat mode.")
    mob_health = 45
    while mob_health > 0:
        print(
            "     _,.\n   ,` -.)\n    ( _/-\ -._\n   /,|`--._,-^|            ,\n   \_| |`-._/||          ,'|\n     |  `-, / |         /  /\n     |     || |        /  /\n      `r-._||/   __   /  /\n  __,-<_     )`-/  `./  /\n '  \   `---'   \   /  /\n'  \   `---'   \   /  /\n    |           |./  /\n    /           //  /\n\_/' \         |/  /\n |    |   _,^-'/  /\n |    , ``  (\/  /_\n  \,.->._    \X-=/^\n  (  /   `-._//^`\n   `Y-.____(__}\n    |     {__)")
        player_attack = (random.randrange(4, 9) + weapon_damage)
        mob_damage = random.randrange(11, 14)
        mob_health -= player_attack
        health -= mob_damage
        if player_attack >= 10:
            print("CRITICAL HIT!")
...
input("YOU DEFEATED THE DRAGON! HIT ENTER TO END GAME")
